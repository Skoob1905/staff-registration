...
export const Body = (props: TypoProps) =>
  el("p", "text-xs sm:text-sm text-[var(--foreground)]", props);

export const BodyBold = (props: TypoProps) =>
  el("p", "text-xs sm:text-sm font-semibold text-[var(--foreground)]", props);

export const BodyMedium = (props: TypoProps) =>
  el("p", "text-xs sm:text-sm font-medium text-[var(--foreground)]", props);

export const Muted = (props: TypoProps) =>
  el("p", "text-xs sm:text-sm text-[var(--muted-foreground)]", props);

export const Caption = (props: TypoProps) =>
  el("p", "text-xs text-[var(--muted-foreground)]", props);

export const Label = (props: TypoProps) =>
  el("label", "text-xs sm:text-sm font-medium text-[var(--foreground)]", props);
