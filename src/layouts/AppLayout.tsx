...
export const AppLayout = () => {
  ...
  const navLinks = isAdmin ? (
    <>
      <NavLink to="/staff" className={navLinkClass} end>STAFF</NavLink>
      <NavLink to="/clients" className={navLinkClass}>CLIENTS</NavLink>
      <NavLink to="/admin" className={navLinkClass}>USERS</NavLink>
      ...
      >
        <div className="mx-auto max-w-6xl px-0 py-3 sm:px-1">
          <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
            ...
            />
            <nav className="order-last flex basis-full justify-center gap-2 sm:order-none sm:basis-auto sm:flex-1">
              {navLinks}
            </nav>
